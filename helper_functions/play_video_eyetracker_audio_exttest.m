function output = play_video_eyetracker_audio_exttest(leftVideo, rightVideo,window,el,width, height,trial, wRect, testAudio)
...
[keyIsDown,secs,keyCode]=KbCheck;
    ...
    for i=1:length(leftVideo)
        ...
        [movie movieduration fps imgw imgh] = Screen('OpenMovie', window, moviename, [], [], specialFlags1, [], []);
        
        [movie2 movieduration fps imgw imgh] = Screen('OpenMovie', window, moviename2, [], [], specialFlags1, [], []);
