function output = play_video_eyetracker_audio_test(leftVideo, rightVideo,window,el,width, height,trial, wRect, testAudio)
...
[keyIsDown,secs,keyCode]=KbCheck;
    for i=1:length(leftVideo)
        ...
        Eyelink('Message', '!V TRIAL_VAR trial %s', 'Test')
