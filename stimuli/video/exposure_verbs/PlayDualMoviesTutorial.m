...
try
    ...
    [xCenter, yCenter] = RectCenter(win);
    gap = 100;
    ...
    while (abortit<2)
        ...
        %rect1=SetRect(1,1,imgw/3,imgh/3);
        
        leftBottomRect = [xCenter - (imgw/3), yCenter + (imgh*.667), xCenter, yCenter + (imgh/3)];
        ...
        %rect2=SetRect(1,1,imgw/3,imgh/3);
        %rect2=AdjoinRect(rect2, rect1, RectRight);
        rightBottomRect = [xCenter + (imgw/3), yCenter + (imgh*.667), xCenter + (imgw/3) + gap, yCenter + (imgh/3)];
        ...
        while 1
            ...
            if (abs(rate)>0)
                ...
                if tex>0
                    ...
                    Screen('DrawTexture', win, tex, [], leftBottomRect);
                    % Release texture:
                    Screen('Close', tex);
                end;
                ...
                if tex2>0
                    ...
                    Screen('DrawTexture', win, tex2, [], rightBottomRect, angle, [], alpha);
                    % Release texture:
                    Screen('Close', tex2);
                end;
        ...
        while 1
            ...
            if (abs(rate)>0)
                ...
                Screen('DrawTexture', win, masktex, [], rightBottomRect);
                ...
                if tex2>0
                    ...
                    Screen('DrawTexture', win, tex2, rightBottomRect, rightBottomRect);
                    % Release texture:
                    Screen('Close', tex2);
                end;
